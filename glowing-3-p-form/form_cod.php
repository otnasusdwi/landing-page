...
<head>
	...
	<script>
		...
		<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=<?=$f2_header?>&ev=PageView&noscript=1"/></noscript>
						...
						<div class="col-md-8">
							<div class="box effect1">
								...
								<form action="submit2.php" method="post" id="form" name="form">
									...
									<input type="hidden" name="no_cs" value="<?=$no_cs;?>">
									<input type="hidden" id="price" name="price" value="377200">
									<input type="hidden" id="qty" name="qty" value="1">
									<input type="hidden" id="amount" name="amount" value="377200">
									...
									<input type="tel" minlength="10" maxLength="15" name="wa"  value="<?=$wa;?>" required onkeypress="return validateNumber(this)">
									...
									foreach($dataprov as $row){
										...
										echo '<option id="'.$row['provinsi_code'].'" value="'.$row['provinsi_name'].'" required>'.$row['provinsi_name'].'</option>';
									...
									<select id="kabupaten" name="kabupaten" onkeyup="changeInput4()" required>
		...
		<div class="section" id="footer">
			...
			$.ajax({
				...
				success: function (data) {
					...
					$("#total").html(
						"<h4 class='text-center'>Ongkos Kirim <br>Rp. "+ongkir+"</h4><br>"+
						"<br><h2 class='heading text-center'  style='line-height: 40px; font-size: 30px;'><strong>Total <br>Rp "+total+"</strong></h2>");
				}
			});
		});

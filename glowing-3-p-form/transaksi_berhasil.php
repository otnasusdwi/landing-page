...
<head>
    ...
    <meta http-equiv="refresh" content="5;URL='http://api.whatsapp.com/send?l=id&phone=<?=$no_cs?>&text=Nama%20Saya%20*<?=$nama?>*%0A%0ASaya%20sudah%20order%20*<?=$product?>*%0A%0AMetode%20pembayaran:%20*<?=$pembayaran?>*%0A%0ATolong%20kirim%20ke%20alamat%0AAlamat%20lengkap:%20<?=$alamat_lengkap?>%0AKecamatan:%20<?=$kecamatan?>%0AKabupaten:%20<?=$kabupaten?>%0AProvinsi:%20<?=$provinsi?>%0A%0ATolong%20dikirim%20hari%20ini%20ya!" /> 
    ...
    <div id="main-wrapper" class="mm-page mm-slideout">
        ...
        <div class="section section-lg" id="section-blog">
            <div class="container" id="ordernow">
                ...
                <h3 class="heading text-center"><strong><a href="#" onclick="window.history.go(-2);" class="button" style="color: #fff;">Kembali Ke Website</a></strong></h3><br><br>

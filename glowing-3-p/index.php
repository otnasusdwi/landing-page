...
<html class="" lang="en">
    <head>
        ...
        <!-- meta fb og start -->
        <meta property="og:url" content="https://kepompongemas.id/heptaco/pixel/wa.php">
        ...
        <meta property="og:site_name" content="kepompongemas.id">
    ...
    @media (max-width: 767px){
        ...
        <script>
          ...
          fbq('init', '455057638669952');
          fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
          src="https://www.facebook.com/tr?id=455057638669952&ev=PageView&noscript=1"
        /></noscript>
...
<script>
  fbq('track', 'ViewContent');
    ...
    <div class="section" id="section-kulit">
        <div class="heading">
            <h4>Bunda Ingin:</h4>
            <h1><strong>Wajah Glowing</strong> dalam <strong>30 Hari?</strong><h1>
            <h4>Tanpa <strong>Ribet</strong> Tapi <strong>100% Aman?</strong></h4>

            <h5>Teruskan Membaca, Ada <strong>Solusi Ampuh dari Dokter Luci</strong></h5>
    ...
    <div class="section" id="footer">
        <div class="container">        
            ...
            <h4 class="heading text-center"><strong><font color="red">FAKTA 1:</font></strong><br>Setelah usia 30, Wanita Karir atau Ibu Rumah Tangga daya tahan tubuhnya <strong>MENURUN 1% tiap tahun.</strong>.<br><br><strong><font color="red">FAKTA 2:</font></strong><br>SINAR MATAHARI adalah faktor <strong>PALING JAHAT</strong> yang menyebabkan <strong>semua masalah kulit wajah</strong>.</h4><div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="section section-lg" id="section-blog">
        <div class="container">
            <h4 class="heading text-center">Bayangkan jika Bunda tidak melakukan perawatan wajah dan membiarkan <strong>kulit tanpa nutrisi</strong>.<br><br>Terlebih membiarkan wajah <strong>terpapar sinar matahari</strong> tiap hari tanpa perlindungan.</h4><br>
            <h4 class="heading text-center"><font color="red"><strong>Sinar UV</strong> menembus lapisan dermis kulit menyebabkan <strong>kehilangan elastistas</strong> dan pelepasan pigmen sehingga kulit <strong>menjadi gelap dan kendur.</strong></font></h4><br>

            <h4 class="heading text-center"><strong>Akibatnya kulit wajah menjadi KUSAM, keriput, TIDAK MENARIK, dan terlihat CEPAT TUA dari usia aslinya.</strong></h4><br>
    ...
    <div class="section section-lg" id="section-blog">
        <div class="container">
            <h4 class="heading text-center"><i>Bunda pun menjadi <strong>Tidak PeDe</strong>, Membatasi Pergaulan, <strong>Kurang Eksis</strong> bahkan terhambat mengembangkan <strong>Potensi Diri dan Karir</strong>.</i></h4><br>
            <h4 class="heading text-center"><font color="green">Jika usia <strong>Bunda diatas 30</strong> dan memiliki masalah kulit wajah, SEGERALAH melakukan <strong>perawatan secara teratur</strong> dengan produk <strong>SKINCARE terpercaya</strong>.</font></h4><br>
    ...
    <div class="section" id="footer">
        <div class="container">        
            ...
            <h3 class="heading text-center"><strong>Sudah Mencoba Berbagai Macam SKINCARE Namun Tidak Menampakkan Hasil?</strong></h3>
            <h4 class="heading text-center"><strong><font color="red">STOP Memakai Skincare TIDAK JELAS, Tidak Berijin, dan Memakai Bahan Kimia BERBAHAYA</font></strong></h4><br>
            <h4 class="heading text-center">Jangan PERTARUHKAN <strong>WAJAH Bunda</strong> menjadi <strong>semakin parah</strong> bahkan beresiko terkena <strong>KANKER KULIT!</strong></h4>
    ...
    <div class="section section-lg" id="section-blog">
        <div class="container">
            <h3 class="heading text-center"><strong>Berita Baiknya,</strong> ada BAHAN ALAMI, langka, PREMIUM, terbaik di dunia, dan SANGAT MIRIP dengan <strong>nutrisi kulit wajah manusia</strong>, YAITU:</h3><br>
        </div>
    </div>
        ...
        <div class="product-info-box">
            <div class="container">
                ...
                <div class="text">
                    ...
                    <h4 style="text-align: left;"><strong>Kepompong Emas</strong> dari ulat sutera pemakan daun Mulberry memiliki <strong>efek antioxidant dan whitening yang kuat</strong>.</h4>
                    <h4 style="text-align: left;">Mengandung <strong>sericin sangat tinggi</strong> yang mampu <strong>menghambat proses penghitaman kulit </strong> (melanogenesis).</h4>
                    <h4 style="text-align: left;"><strong>Asam amino</strong> yang terkandung <strong>hampir sama dengan susunan kulit kita</strong> sebagai <strong>anti aging dan moisturizer natural</strong>.</p>                     
                </div>
            </div>
        </div>
    ...
    <div class="section section-lg" id="section-blog">
        ...
        <div class="section section-lg" id="section-blog">
            <div class="container">
                <h3 class="heading text-center"><strong>HASIL DARI KERJASAMA INILAH<br>PERKENALKAN:</strong></h3><br><p align="center"><img src="assets/img/arrows-transparent-animated-gif-1.gif" width="50"></p>
            </div>
        </div>
    ...
    <div class="section section-lg" id="section-blog">
        ...
        <div class="product-info-box">
            <div class="container">
                ...
                <div class="text">
                    ...
                    <p style="text-align: left;"><strong>Krim Siang dan Krim Malam.</strong> Mengandung asam amino sericin yang
                        berfungsi sebagai anti <span style="font-style: italic;">aging</span>, <span style="font-style: italic;">brightening</span>,
                        dan <span style="font-style: italic;">moisturizer</span>. Dikombinasikan
                        dengan antioksidan <span style="font-style: italic;">botanical </span>ekstrak kakadu yag
                        berfungsi sebagai anti <span style="font-style: italic;">aging
                        </span>dan mencerahkan kulit. <br><br>Kandungan ekstrak bunga <span style="font-style: italic;">daisy</span>-nya
                        efektif mencerahkan, <b>mengurangi spot hitam</b>, dan memperbaiki efek buruk yang
                        disebabkan oleh sinar ultra-violet. Kulit jadi terasa bersih,
                        lembut, dan bercahaya.</p>
                    <p style="text-align: left;"><span style="font-weight: bold;">BPOM RI NA 18151900130</span><br></p>
        ...
        <div class="product-info-box">
            <div class="container">
                ...
                <div class="text">
                    <h3>Royal Golden Cocoon Deep Cleanser</h3>
                    <p>
                    </p>
                    <p style="text-align: left;"><strong>Facial Wash Gel</strong>. Mengandung asam amino sericin dan sun
                        flower oil yang berfungsi sebagai anti aging botanical moisturizer dan
                        mencerahkan kulit. Kombinasi sempurna yang menjadikan kulit wajah tampak lebih
                        bersih, cerah, segar, terawat, dan terjaga kelembabannya.</p>
                    <p style="text-align: left;">Untuk mencuci wajah dipakai pagi atau siang sebelum memakai Krim Malam.</p>
        ...
        <div class="product-info-box">
            <div class="container">
                ...
                <div class="text">
                    <h3>Royal Golden Cocoon UV Protection Cream</h3>
                    <p>
                    </p>
                    <p>
                    <p style="text-align: left;">Mengandung <span style="font-style: italic;">asam amino</span> yang berfungsi sebagai <span style="font-style: italic;">anti aging,
                            moisturizer</span>, dan mencerahkan kulit. <span style="font-style: italic;">Bifida Ferment Lysate</span>-nya dapat mencegah
                        terjadinya kerusakan kulit yang disebabkan oleh sinar UV dengan SPF 30.</p><p class="MsoNormal">Produk Royal Golden Cocoon Uv Protection Cream telah resmi tercatat
                        dengan nomor:</p><p>
        ...
        <div class="section section-lg">
            <div class="container">
                <p style="text-align: center;"> <img src="assets/img/testimoni_01_Putri_WA_Before_After.jpg" width="280px"></p>
                <p style="text-align: center;"> <img src="assets/img/testimoni_02_Sela_WA_Before_After.jpg" width="280px"></p>
                <p style="text-align: center;"> <img src="assets/img/testimoni_03_Nia_WA_Before_After.jpg.jpg" width="280px"></p>
            </div> 
        </div>
        ...
        <div class="product-info-box">
            <div class="container">
                ...
                <div class="text">
                    ...
                    <h4><strong>Hayyana UV Protection Cream</strong><br><i>(Krim Siang - Tabir Surya 30gr)</i></h4>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <p align="center"><img src="assets/img/red-arrow.gif">
                    ...
                    $cs = [
                        ...
                        ['name' => 'Imelda', 'mobile' => '6281911106479', 'email' => 'cs4.heptaco@gmail.com'],
                        ['name' => 'Imelda', 'mobile' => '6281911106479', 'email' => 'cs4.heptaco@gmail.com'],
                        // ['name' => 'Melisa', 'mobile' => '6282323920151', 'email' => 'cs5.heptaco@gmail.com'],
                        // ['name' => 'Melisa', 'mobile' => '6282323920151', 'email' => 'cs5.heptaco@gmail.com'],
                        // ['name' => 'Melisa', 'mobile' => '6282323920151', 'email' => 'cs5.heptaco@gmail.com'],
                        // ['name' => 'Melisa', 'mobile' => '6282323920151', 'email' => 'cs5.heptaco@gmail.com'],
                        // ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        ['name' => 'Desy', 'mobile' => '6282323920188', 'email' => 'cs6.heptaco@gmail.com'],
                        // ['name' => 'Sali', 'mobile' => '6281806697807', 'email' => 'cs7.heptaco@gmail.com'],
                        ['name' => 'Sali', 'mobile' => '6281806697807', 'email' => 'cs7.heptaco@gmail.com'],
                        ['name' => 'Sali', 'mobile' => '6281806697807', 'email' => 'cs7.heptaco@gmail.com'],
                        ['name' => 'Sali', 'mobile' => '6281806697807', 'email' => 'cs7.heptaco@gmail.com'],
                        ['name' => 'Sali', 'mobile' => '6281806697807', 'email' => 'cs7.heptaco@gmail.com'],

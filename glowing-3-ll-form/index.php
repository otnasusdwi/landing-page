			...
			<div class="section" id="section-kulit">
				<div class="heading">
					...
					<h1><strong>Wajah Glowing</strong> dalam <strong>30 Hari?</strong><h1>
						<h3>Tanpa <strong>Ribet</strong> Tapi <strong>100% Aman?</strong></h3>

						<h3 class="jarak">Teruskan Membaca, Ada <strong>Solusi Ampuh dari Dokter Luci</strong></h3>
				...
				<section class="section">
					<div class="product-info-box">
						...
						<div class="zoom-gallery text-center">
							<a href="assets/img/testimoni_01_Putri_WA_Before_After.jpg" ><img src="assets/img/testimoni_01_Putri_WA_Before_After.jpg" width="280px" height="280px"></a><br><br>
							<a href="assets/img/testimoni_02_Sela_WA_Before_After.jpg"><img src="assets/img/testimoni_02_Sela_WA_Before_After.jpg" width="280px" height="280px"></a><br><br>
							<a href="assets/img/testimoni_03_Nia_WA_Before_After.jpg.jpg"><img src="assets/img/testimoni_03_Nia_WA_Before_After.jpg.jpg" width="280px" height="280px"></a>
						</div>
					...
					<!-- 	<div class="section section-lg">
							<div class="container">
								<div class="zoom-gallery text-center">
									 <a href="assets/img/testimoni_01_Putri_WA_Before_After.jpg"><img src="assets/img/testimoni_01_Putri_WA_Before_After.jpg" width="280px">
									 <a href="assets/img/testimoni_02_Sela_WA_Before_After.jpg"><img src="assets/img/testimoni_02_Sela_WA_Before_After.jpg" width="280px">
									 <a href="assets/img/testimoni_03_Nia_WA_Before_After.jpg.jpg"><img src="assets/img/testimoni_03_Nia_WA_Before_After.jpg.jpg" width="280px">
								</div>
							</div> 
						</div> -->
									...
									<div class="col-md-8">
										<div class="box effect1">
											<form action="submit.php" method="post" id="form" name="form">
												...
												<input type="text" id="name" name="nama" placeholder="Nama Penerima Paket" onkeyup="changeInput1()" required="">
												<label for="lname" id="labelnohp">Nomor WA</label>
												<input type="text" id="number" minlength="10" maxlength="15" name="wa" placeholder="Nomor WhatsApp" value="62" required="">
												<div id="footerform">

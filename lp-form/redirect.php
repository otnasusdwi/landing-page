...
img.logo {
  ...
  fbq('track', 'Purchase', {
    ...
    <script type="text/javascript">
        var wrdly = 1000,
            wrrdr = "whatsapp://send?phone=<?php echo $mobile; ?>&text=<?php echo $message; ?>",
            wrsto = !1;
        setTimeout(function () {
            wrsto = !0
        }, 1);
...
<body>
   ...
   <!--  <img src="assets/img/img_ENTKUJf.png" alt="hayyana"></a> -->
    <div class="shadow"><img class="logo" src="assets/img/img_ENTKUJf.png" /></div>
    ...
    <div class="wpbisnis-text">
        <div class="wpbisnis-message">
            <div class="wpbisnis-loading-text">
                Tunggu sebentar, Anda akan segera terhubung dengan customer service kami. Atau klik tombol di bawah ini untuk menghubungi customer service kami. </div>
        </div>
        <div class="wpbisnis-phone">
            <a href="whatsapp://send?phone=<?php echo $mobile; ?>&text=<?php echo $message; ?>">

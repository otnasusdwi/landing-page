...
<head>
	...
	<title>Transaksi Berhasil | Hayyana, Royal Beauty Secret | Ekstrak Kepompong Emas Produk Perawatan Wajah Wanita dan Pria</title>
	...
	<script>
		...
		{if(f.fbq)return;n=f.fbq=function(){n.callMethod?
			...
			fbq('init', '617839312084808');
			fbq('track', 'PageView');
		</script>
		<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=617839312084808&ev=PageView&noscript=1"
			/></noscript>
			...
			<div id="main-wrapper" class="mm-page mm-slideout">
				...
				<div class="section section-lg" id="section-blog">
					<div class="container" id="ordernow">
						<h3 class="heading text-center"><strong>CS Kami Akan Segera Menghubungi Anda Sekarang Melalui Whatsapp untuk Konfirmasi Pengiriman</strong></h3><br>
						<h4 class="heading text-center"><strong>Bunda Juga Bisa Konsultasi dengan CS Kami yang Dibimbing oleh Team Ahli Kulit Natasha Group.</strong></h4><br>
						<h3 class="heading text-center"><strong><a href="#" onclick="window.history.go(-1);" class="button" style="color: #fff;">Kembali Ke Form Order COD</a></strong></h3><br><br>
					</div>
				</div>
